...
static irqreturn_t buttons_interrupt(int irq, void *dev_id)
{
	...
	*press_cnt = *press_cnt + 1;
	...
	kill_fasync(&button_async, SIGIO, POLL_IN); /* 给应用程序发信号 */
...
static int s3c24xx_buttons_fasync(int fd, struct file *filp, int on)
{
	printk("driver: s3c24xx_buttons_fasync\n");
